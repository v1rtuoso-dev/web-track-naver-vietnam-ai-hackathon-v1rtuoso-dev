                                ...
                                <div className="text-sm text-gray-600 dark:text-gray-300 flex items-start">
                                    ...
                                    <p>
                                        {t(
                                            ...
                                            'Connect your tototodo account to a Telegram bot to add items to your inbox via Telegram messages.'
                                        )}
                                    </p>
                                </div>
                                    ...
                                    <div className="p-2 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-800 rounded text-green-800 dark:text-green-200">
                                        <p className="text-sm">
                                            {t(
                                                ...
                                                'Your Telegram account is connected! Send messages to your bot to add items to your tototodo inbox.'
                                            )}
                                        </p>
                                    </div>
                                )}

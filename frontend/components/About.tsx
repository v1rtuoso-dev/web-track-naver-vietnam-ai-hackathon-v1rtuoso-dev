                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            {t(
                                'about.appreciation',
                                'Thank you for using tototodo! Your support helps keep this project alive and growing. If you find it useful, consider supporting the development.'
                            )}
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <a
                                href="https://reddit.com/r/tototodo"
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <div className="text-center">
                        <div className="space-y-2">
                            <a
                                href="https://github.com/chrisvel/tototodo"
                                target="_blank"
                                rel="noopener noreferrer"

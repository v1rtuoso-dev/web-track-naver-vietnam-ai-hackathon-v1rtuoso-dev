    ...
    switch (command.toLowerCase()) {
        ...
        case '/help':
            await sendTelegramMessage(
                botToken,
                chatId,
                `📋 tototodo Bot Help\n\nSend me any text message and I'll add it to your tototodo inbox as an inbox item.\n\nCommands:\n/start - Welcome message\n/help - Show this help message\n\nJust type your item and I'll take care of the rest!`,
                messageId
            );
            break;
        default:
...
const processMessage = async (user, update) => {
    ...
    if (!user.telegram_chat_id) {
        ...
        await sendTelegramMessage(
            ...
            chatId,
            `🎉 Welcome to tototodo!\n\nYour personal task management bot is now connected and ready to help!\n\n📝 Simply send me any message and I'll add it to your tototodo inbox as an inbox item.\n\n✨ Commands:\n• /help - Show help information\n• /start - Show welcome message\n• Just type any text - Add it as an inbox item\n\nLet's get organized! 🚀`
        );
